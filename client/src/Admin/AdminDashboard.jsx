...
//     { id: "admins", label: "Admins", icon: <UserCircle size={20} /> },
...
//         {/* Main Content */}
//         <main className={`flex-1 p-6 ${sidebarOpen ? "lg:ml-64" : "lg:ml-20"}`}>
//           {/* Welcome Banner */}
...
//                   { action: "Hotel added", time: "15 min ago", type: "hotel" },
//                   { action: "Staff member registered", time: "1 hour ago", type: "staff" },
