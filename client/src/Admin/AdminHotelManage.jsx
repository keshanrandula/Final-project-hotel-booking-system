...
export default function AdminHotelManage() {
  ...
  const deleteHotel = async (id) => {
    ...
    try {
      await api.delete(`/hotels/admin/${id}`);
  ...
  const updateHotel = async () => {
    ...
    try {
      await api.put(`/hotels/admin/${selectedHotel._id}`, data, {
  ...
  return (
    <div className="p-8 bg-gray-100 min-h-screen">
      ...
      <h1 className="text-3xl font-bold mb-6">Admin Hotel Management</h1>

      {/* HOTEL CARDS */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {hotels.map((hotel) => (
          <div key={hotel._id} className="bg-white rounded-xl shadow">
            {hotel.images?.[0] && (
              <img
                src={hotel.images[0]}
      ...
      {selectedHotel && (
        <div className="fixed inset-0 bg-black/40 flex justify-center items-center">
          <div className="bg-white p-6 rounded-xl w-full max-w-lg">
            <h2 className="text-xl font-semibold mb-4">Update Hotel</h2>
