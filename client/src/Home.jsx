...
export default function Home() {
  ...
  const handleViewHotel = (hotelId) => {
    ...
    console.log("Navigating to hotel room page:", selectedHotel.name);
    
    // Navigate to hotelroom page with complete hotel object
    navigate('/hotelroom', {
      state: { 
        hotel: selectedHotel,
        checkIn,
            ...
            {[
              ...
              return (
                <div
                  ...
                  onClick={() => {
                    setDestination(city.name);
                    // Trigger search after setting destination
