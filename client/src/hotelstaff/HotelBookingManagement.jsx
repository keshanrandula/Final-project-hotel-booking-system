...
export default function HotelBookingManagement() {
  ...
  const handleCancelBooking = async () => {
    ...
    try {
      ...
      const response = await axios.delete(`http://localhost:5000/api/bookings/${bookingToCancel._id}`);
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full">
              <div className="p-6">
                ...
                <p className="text-gray-600 text-center mb-6">
                  ...
                  <span className="font-semibold">{bookingToCancel.customerName}</span>?
                </p>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-6">
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{formatDate(bookingToCancel.checkIn)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Check Out:</span>
                      <span className="font-medium">{formatDate(bookingToCancel.checkOut)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Total Amount:</span>
                      <span className="font-bold text-green-600">Rs. {bookingToCancel.totalAmount}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Payment Status:</span>
                      {bookingToCancel.isPaid ? (
                ...
                <p className="text-sm text-red-600 bg-red-50 p-3 rounded-lg mb-6">
                  <strong>Note:</strong> This action cannot be undone. The booking will be permanently deleted from the system.
                </p>
                ...
                <div className="flex space-x-3">
                  ...
                  <button
                    ...
                    disabled={cancelling}
                    className="flex-1 px-4 py-3 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                  >
                    {cancelling ? (
                      <>
