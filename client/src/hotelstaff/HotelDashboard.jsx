...
// //       <h2 className="text-2xl font-bold mb-4">Hotel Profile</h2>
...
// //         <img
// //           key={idx}
// //           src={img} // <-- use the full URL or relative /uploads path
// //           alt="hotel"
...
//       {hotel.images && hotel.images.length > 0 && (
//         <div className="mt-4">
//           <h3 className="font-semibold mb-2">Hotel Images</h3>
//           <div className="flex flex-wrap gap-4">
//             {hotel.images.map((img, idx) => (
//               <img
//                 key={idx}
//                 src={img} // full or relative URL (e.g. /uploads/...)
//                 alt="hotel"
//                 className="w-32 h-24 object-cover rounded-md"
//               />
//             ))}
